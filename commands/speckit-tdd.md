---
description: "Red-green-refactor TDD where the behaviors under test come from the active Spec Kit feature — Acceptance Scenarios and FR-### in spec.md drive the test list, test names cite the FR/SC they verify, and completed cycles tick the matching tasks in tasks.md."
---
...
See the **Good and Bad Tests** and **When to Mock** sections below.
...
- [ ] Identify opportunities for deep modules (see the **Deep Modules** section below — small interface, deep implementation)
- [ ] Design interfaces for testability (see the **Interface Design for Testability** section below)
...
After all tests pass, look for refactor candidates (see the **Refactor Candidates** section below):
...
Writeback as you go (see the **Artifact Map** at the end of this command):
