---
description: "Compact the current conversation into a handoff document for another agent to pick up — anchored to the active Spec Kit feature (branch, FEATURE_DIR, phase, open tasks), referencing spec-kit artifacts by path instead of duplicating them."
---
